...
namespace IZONE.Members
{
    public sealed class Strawberry : Member
    {
        public Strawberry()
        {
            ...
            BirthDayImage_AM = Image.FromFile(Application.StartupPath + @"\BirthDayImage\히토미_오전.jpg");

            BirthDayImage_PM = Image.FromFile(Application.StartupPath + @"\BirthDayImage\히토미_오후.jpg");
