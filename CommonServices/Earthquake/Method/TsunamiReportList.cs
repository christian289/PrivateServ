    ...
    public class TsunamiReportList : EarthquakeBase
    {
        ...
        public Entity.Response.TsunamiReportList TsunamiReportListRes
        {
            ...
            private set
            {
                if (ReferenceEquals(_TsunamiReportListRes, null) || !_TsunamiReportListRes.code.Equals(value.code))
                {
                    ...
                    if (!string.IsNullOrEmpty(_TsunamiReportListRes.code)) // Exception으로 인해 기본 생성자가 할당되었을 경우 Callback Pass
                    {
                        InComming();
                    }   
                }
        ...
        public override async void Service()
        {
            ...
            while (iCount > 0)
            {
                ...
                {
                    if (ReferenceEquals(TsunamiReportListRes, null))
                    {
                        TsunamiReportListRes = new Entity.Response.TsunamiReportList();
                    }
                }
